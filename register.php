...
<main class="form-signin w-100 m-auto">
  ...
  <form action="handle_register.php" method="post">
    ...
    <h3 class="h5 mb-3 fw-normal">welcome sign up now, and join</h3>
      <!-- <php
...
?> -->
    ...
    <div
     ...
     <strong>Alert Heading</strong> you are already registerd,please!. <a href="index.php">login</a>

    </div>
    <div class="form-floating">
      <input type="text" name="name" class="form-control" id="floatingInput" placeholder="karim hossam" autocomplete="off">
